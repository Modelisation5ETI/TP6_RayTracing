                          ...
                          int& index_intersected_primitive)
{
    ...
    //        Doit mettre a jour intersection et & avec l'intersection la plus proche
    //
    // ********************************************* //
    // ********************************************* //
...
bool is_in_shadow(vec3 const& p,vec3 const& p_light, scene_parameter const& scene)
{
    // ********************************************* //
    //
    // Calcule si le point p est dans l'ombre de la lumiere situee en p_light
    //
    // ********************************************* //
...
//    int id=0;
//    return compute_intersection(r,scene,intersection,id);
    return false;
